...
type School struct {
	...
	LastRecordsUploadedAt *time.Time     `gorm:"column:last_records_uploaded_at" json:"last_records_uploaded_at"`
...
type SchoolMapData struct {
	...
	LastRecordsUploadedAt *time.Time `json:"last_records_uploaded_at"`
}
